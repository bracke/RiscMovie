...
package body RASCAL.ToolboxOptionButton is
   ...
   begin
      ...
      if Error /= null then
         pragma Debug(Reporter.Report("ToolboxOptionButton.Get_Event: " & To_Ada(Error.ErrMess)));
   ...
   begin
      ...
      if Error /= null then
         pragma Debug(Reporter.Report("ToolboxOptionButton.Get_Label: " & To_Ada(Error.ErrMess)));
         OS.Raise_Error(Error);
      end if;
   ...
   begin
      ...
      if Error /= null then
         pragma Debug(Reporter.Report("ToolboxOptionButton.Get_State: " & To_Ada(Error.ErrMess)));
         OS.Raise_Error(Error);
      end if;
   ...
   begin
      ...
      if Error /= null then
         pragma Debug(Reporter.Report("ToolboxOptionButton.Set_Event: " & To_Ada(Error.ErrMess)));
         OS.Raise_Error(Error);
      end if;
   end Set_Event;
   ...
   begin
      ...
      if Error /= null then
         pragma Debug(Reporter.Report("ToolboxOptionButton.Set_Font: " & To_Ada(Error.ErrMess)));
         OS.Raise_Error(Error);
      end if;
   end Set_Font;
   ...
   begin
      if Buffer_Size > -1 then
         ...
         if Error /= null then
            pragma Debug(Reporter.Report("ToolboxOptionButton.Set_Label: " & To_Ada(Error.ErrMess)));
            OS.Raise_Error(Error);
         end if;
      end if;
   end Set_Label;
   ...
   begin
      ...
      if Error /= null then
         pragma Debug(Reporter.Report("ToolboxOptionButton.Set_State: " & To_Ada(Error.ErrMess)));
         OS.Raise_Error(Error);
      end if;
   end Set_State;
